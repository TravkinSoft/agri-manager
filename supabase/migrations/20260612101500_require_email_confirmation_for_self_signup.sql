/*
  Require explicit email-code confirmation for self-registered companies.

  Self-signup creates the company and owner profile in pending status.
  The app activates the profile only after Supabase verifies the signup OTP.
*/
