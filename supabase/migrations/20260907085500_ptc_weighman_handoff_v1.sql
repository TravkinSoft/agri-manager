-- Split the potato traffic handoff between three operational roles:
-- mechanic_operator: empty -> loaded; weighman: loaded -> unloading;
-- vegetable_brigadier: unloading -> empty.
...
declare a public.profiles%rowtype; person public.company_people%rowtype; s public.ptc_vehicle_states%rowtype; e public.ptc_events%rowtype; company uuid; linked_count integer; actor_label text;
begin
