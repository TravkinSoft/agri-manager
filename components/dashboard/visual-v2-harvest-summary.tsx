  ...
  return (
    <div className="min-w-0">
      ...
      <Select value={value || "all"} onValueChange={(next) => onChange(next === "all" ? null : next)}>
        <SelectTrigger aria-label={label} className="tf-input-surface tf-focus-ring h-12 min-w-0 text-base text-[color:var(--tf-text-primary)] sm:h-10 sm:text-sm"><SelectValue /></SelectTrigger>
