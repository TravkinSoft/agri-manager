      ...
      const response = await fetch("/api/assistant/query", {
        ...
        body: JSON.stringify({
          ...
          runtimeContext: {
            ...
            currentModule: runtimeContext?.currentModule || runtimeContext?.currentPage || "specialist",
            entity: runtimeContext?.entity || null,
            selectedRows: runtimeContext?.selectedRows || [],
            filters: runtimeContext?.filters || {},
            season: runtimeContext?.season || "2026",
            defaultSeason: runtimeContext?.defaultSeason || "2026",
            companyId: profile.company_id,
            companyName: runtimeContext?.companyName || null,
            userId: profile.id || null,
            userRole: profile.role || null,
            selectedEntityType: runtimeContext?.selectedEntityType || runtimeContext?.entity?.type || null,
            selectedEntityId: runtimeContext?.selectedEntityId || runtimeContext?.entity?.id || null,
            selectedFieldId: runtimeContext?.selectedFieldId || null,
            selectedFieldLabel: runtimeContext?.selectedFieldLabel || null,
            selectedWarehouseId: runtimeContext?.selectedWarehouseId || null,
            selectedWarehouseLabel: runtimeContext?.selectedWarehouseLabel || null,
            selectedCropStructureSectionId: runtimeContext?.selectedCropStructureSectionId || null,
            selectedCropStructureSectionLabel: runtimeContext?.selectedCropStructureSectionLabel || null,
            selectedOperationId: runtimeContext?.selectedOperationId || null,
            selectedOperationLabel: runtimeContext?.selectedOperationLabel || null,
            selectedTicketId: runtimeContext?.selectedTicketId || null,
            selectedTicketLabel: runtimeContext?.selectedTicketLabel || null,
            selectedBatchId: runtimeContext?.selectedBatchId || null,
            selectedBatchLabel: runtimeContext?.selectedBatchLabel || null,
            selectedCrop: runtimeContext?.selectedCrop || null,
            language: runtimeContext?.language || language || "ru",
