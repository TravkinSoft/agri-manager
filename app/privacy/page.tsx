    ...
    <main className="min-h-screen bg-card text-foreground">
      <header className="border-b border-border bg-card/95">
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-5 sm:px-6">
          ...
          <Link
            href="/"
            className="rounded-xl border border-border px-4 py-2 text-sm font-semibold text-foreground hover:bg-accent/40"
          >
            На главную
          </Link>
        </div>
      ...
      <article className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="rounded-3xl border border-yellow-400/20 bg-card p-6 shadow-2xl shadow-black/25 sm:p-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm text-muted-foreground">
            <span className="rounded-full border border-border px-3 py-1.5">Версия 1.1</span>
            <span className="rounded-full border border-border px-3 py-1.5">Дата вступления в силу: 16 сентября 2026 года</span>
          </div>
        </div>

        <div className="mt-8 space-y-8 rounded-3xl border border-border bg-accent/40 p-6 text-[15px] leading-7 text-foreground sm:p-10">
          <section>
            <h2 className="text-2xl font-black text-foreground">1. Кто обрабатывает данные</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground">2. Какие данные обрабатываются</h2>
            <ul className="mt-3 list-disc space-y-2 pl-6 marker:text-amber-800">
              ...
              <li>файлы, документы или аудиозаписи только тогда, когда пользователь сам запускает доступную ему функцию импорта, загрузки или распознавания речи в веб-продукте или Android-приложении;</li>
            ...
            <p className="mt-3">
              Android-приложение может запрашивать разрешение на уведомления и геолокацию устройства только при использовании соответствующей функции. Доступ к камере, микрофону или файлам возможен только после явного действия пользователя через системный или браузерный выбор и соответствующее разрешение. Приложение не запрашивает доступ к контактам, SMS или звонкам и не содержит рекламных или аналитических SDK.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-black text-foreground">3. Цели обработки</h2>
            <ul className="mt-3 list-disc space-y-2 pl-6 marker:text-amber-800">
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground">4. Основания обработки</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground">5. Передача и поставщики инфраструктуры</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground">6. Хранение и удаление</h2>
            <p className="mt-3">
              <Link href="/account-deletion" className="font-semibold underline underline-offset-4">Запросить удаление аккаунта TravkinFlow и связанных данных</Link>. Инструкция доступна без входа в аккаунт.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground">7. Защита данных</h2>
            <p className="mt-3">
              Передача выполняется по HTTPS. Доступ ограничивается ролью и контекстом организации. Android-приложение открывает защищённую версию travkinflow.com, использует системный браузерный движок для хранения сессии, не сохраняет пароль TravkinFlow и завершает активную сессию при выходе пользователя.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-black text-foreground">8. Права и запросы пользователя</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground">9. Дети</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground">10. Изменения политики</h2>
            <p className="mt-3">
          ...
          <section className="rounded-2xl border border-yellow-400/20 bg-yellow-400/10 p-5">
            <h2 className="text-xl font-black text-amber-800">Контакты</h2>
            <p className="mt-2 text-amber-800">Оператор: {operatorName}</p>
            <p className="text-amber-800">Поддержка и запросы по данным: {supportEmail}</p>
          </section>
        </div>
      </article>
    </main>
