      ...
      <article className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="rounded-3xl border border-yellow-400/20 bg-card p-6 shadow-2xl shadow-black/25 sm:p-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm text-muted-foreground">
            <span className="rounded-full border border-border px-3 py-1.5">Версия 1.0</span>
            <span className="rounded-full border border-border px-3 py-1.5">Дата вступления в силу: 2 сентября 2026 года</span>
          </div>
        </div>
