        ...
        <CardContent>
          {loading ? (
            <div className="text-center py-12">
              <p className="text-muted-foreground">{t("Загрузка данных...", "Деректер жүктелуде...", "Loading data...")}</p>
            </div>
          ) : fieldHistory.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-muted-foreground">{t("История отсутствует.", "Тарих жоқ.", "No history available.")}</p>
            </div>
          ) : (
