              ...
              <TabsContent value="guide" className="space-y-4">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <pre className="bg-background text-foreground p-3 rounded text-xs overflow-x-auto">
{`"fields": [
  { "name": "Field 1", "area": 100.5 },
  { "name": "Field 2", "area": 85.3 }
]`}
...
{`"crop_structure": [
  ...
  { "field_name": "Field 1", "crop": "Barley", "area": 50.0 }
                    ...
                    <div className="text-xs text-muted-foreground">
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {["Wheat", "Barley", "Oats", "Peas", "Potato", "Carrot", "Rapeseed", "Sunflower", "Flax", "Corn"].map(crop => (
                          <span key={crop} className="inline-flex items-center px-2 py-1 rounded-md bg-green-50 text-green-700 dark:bg-green-50 dark:text-green-800 text-xs font-medium">
                            {crop}
                          </span>
                        ))}
                      </div>
                  ...
                  <div>
                    ...
                    <pre className="bg-background text-foreground p-3 rounded text-xs overflow-x-auto max-h-64">
{exampleJSON}
                    </pre>
                    <Button
                      variant="outline"
            ...
            {results && (
              <Alert className="border-green-200 bg-green-50 text-green-900 dark:border-green-800 dark:bg-green-50 dark:text-green-800">
                <CheckCircle2 className="h-4 w-4 text-green-600 dark:text-green-800" />
