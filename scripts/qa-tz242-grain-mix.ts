...
check("38 ordinary crop requires identity", () => assert.equal(validateAndNormalizeCropStructureRows({ rows: [{ land_use_type: "crop" as const, crop_id: "crop-oat", variety_id: null, reproduction_id: null, area: 100 }], cropsById: crops, fieldArea: 100 }).ok, false));
