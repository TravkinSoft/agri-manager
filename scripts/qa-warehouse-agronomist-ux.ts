...
test("warehouse cards share equal-height grid rows", () => assert.equal((page.match(/grid items-stretch gap-3 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4/g) || []).length, 2));
