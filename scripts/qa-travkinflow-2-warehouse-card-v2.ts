...
assert.match(card, /border border-slate-800\/90 bg-\[#141a23\]/);
...
console.log("PASS TravkinFlow 2 warehouse card V2: flat surface, truthful counts/copy and preserved safety states (22 checks)");
