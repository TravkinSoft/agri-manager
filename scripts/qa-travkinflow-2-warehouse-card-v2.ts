...
assert.match(card, /rounded-lg bg-card/);
...
assert.match(card, /data-warehouse-reorder-id=\{reorderable \? warehouse\.id : undefined\}/);
...
assert.doesNotMatch(page, /selectedSummary\.lastMovementAt/);
