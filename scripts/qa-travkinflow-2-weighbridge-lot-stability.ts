...
const lotUiStart = source.indexOf("<Label>Участки / партии урожая *</Label>");
...
assert.match(source, /min-h-\[7\.75rem\] space-y-1\.5[\s\S]{0,120}<Label>Участки \/ партии урожая \*<\/Label>/);
