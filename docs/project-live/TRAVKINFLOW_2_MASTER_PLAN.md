...
- Общий прогресс: `82% программы (оценка, не доля тестов) / 0% Product-релизных волн / 0% финального W6`. Реализация не равна релизу: current Product остаётся `4bae7d9ab2583d635d4c21b22c330ee763bd75e2`.
- Актуальная контрольная точка 2026-09-09 23:18+05:00: основная ветка `bad31ee6d327a8ee46c8c67891a271f7f22974d1` включает исправление мобильных Settings `789a10a` и impersonated harvest dashboard `bad31ee`; они ещё не собраны. Предыдущий exact immutable Preview `b2923ff9ccf0f3579c12d5706b33a6fe559f50d4` / `dpl_5ySDi4j3eS3bySNCCCziFmDa4Q2y` READY, ALL11 QA flags=1. Permanent QA пока85b3678 / `dpl_5AJoTTrgH3VTJNvPYXN9NewJFHcL`, это rollback. Исправление map/mobile overlay ещё выполняется. Нижние ранние checkpoint описывают историю, не заменяют эту строку.
